...
Learning edition **v1.8** connects MOS operating points, common-source stages,
...
The [resistor-noise supplement](examples/learning-noise-v1/README.md) follows
one source through both resistor terminals, compares partial noise powers and
provides a direct branch-current AC replay. These are learning increments; the five
studies below retain their original histories and exact downloads.

The [common-mode supplement](examples/learning-common-mode-v1/README.md) separates
...
The [finite sensing-divider example](examples/learning-feedback-divider-v1/README.md)
keeps the initial six MOS units and adds two 1-MΩ resistors. Its old-OP
forecast, one measured OP/AC condition and retrospective error/current
accounting remain distinct. It includes the original pre-launch input rejection
and a known-input native replay; no new transient or LDO is claimed.
...
is `learning-path-v1.8`. Versioned
