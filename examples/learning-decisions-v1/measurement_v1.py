"""MIT: selected verbatim learning.initial-d1-interface.measure.v1 functions.

Original public learning-day-v1.0 module; this dependency contains no CLI,
acquisition, sample selection or import-time file access. Function bodies are
unchanged and their original hashes are recorded in load-budget-plan.json.
"""
import numpy as np
