...
def main():
    ...
    p.add_argument('--candidate',choices=['R37','A37','R75','A75'],default='R37')
    p.add_argument('--index',type=int,default=1000);p.add_argument('--condition',choices=['nominal','supply_097'],default='nominal')
