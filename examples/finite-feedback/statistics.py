"""MIT: regenerate the finite feedback confirmation statistics from public CSV.
...
def calculate(data):
    ...
    return dict(schema='ads.feedback-statistics.v1', role=plan['role'], summaries=summaries, contrasts=contrasts)
