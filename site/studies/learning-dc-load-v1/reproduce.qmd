---
title: "Reproduce the initial-OTA DC receiving-load example"
---
...
Chapters [4](../../learn/04-differential-pair-and-ota.qmd#a-dc-receiver-needs-current-after-charging-has-ended),
[5](../../learn/05-feedback-and-response.qmd#predict-a-finite-dc-receiving-current-change)
and [8](../../learn/08-toward-an-ldo.qmd) explain the resulting current,
precision and response tradeoff.

Download [the selected package](../../downloads/learning-dc-load-v1.0.zip)
...
The prior package is [learning-day-v1.0.zip](../../downloads/learning-day-v1.0.zip),
...
high-command observation in the [common-mode package](../learning-common-mode-v1/reproduce.qmd).
