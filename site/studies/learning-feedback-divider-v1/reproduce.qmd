---
title: "Reproduce the initial OTA's finite sensing divider"
---
...
Read [the operating connection](../../learn/04-differential-pair-and-ota.qmd#sense-low-while-driving-a-higher-output)
and [the precision argument](../../learn/05-feedback-and-response.qmd#a-finite-sensing-divider-changes-both-the-target-and-its-errors).
Download [learning-feedback-divider-v1.0.zip](../../downloads/learning-feedback-divider-v1.0.zip).
