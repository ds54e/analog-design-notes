...
147 versus 165. Both distributions have shifted below the fixed center.
Narrowing a distribution around a displaced mean need not put more circuits
inside the required ±25-mV window. Removing that shift in postprocessing would
answer a trimmed question that these circuits were not designed to perform.
